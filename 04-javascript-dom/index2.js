...
// 반복을 하고 싶으면..  Array로 변경! (Array.from())
...
pinks.forEach((elem) => console.log(elem)); // 가능

const pinkss = document.getElementsByClassName('pink');
for (let pink of pinkss) {
  console.log(pink);
}
// pinkss.forEach((elem) => console.log(elem)); // 불가
