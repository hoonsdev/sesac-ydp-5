...
// 변수 선언 키워드 1. var
var a; // 변수 선언
console.log(a); // undefined: 값을 할당하지 않음
a = 2; // 변수 할당
...
let b2 = 77; // 변수 선언 & 할당
console.log(b2);
// let b2 = 78; 이렇게는 할당할 수 없음. 중복 선언 불가
b2 = 78; // 변수 값 재할당
console.log(b2);
...
// const c; -> error: const 키워드는 선언과 할당 반드시 동시에 이뤄져야함!
const c = 3;
console.log(c);
// c = 33 -> error: const 변수는 재할당 불가!

// 변수 이름 규칙 (=> 식별자 규칙)
// 식별자: 이름을 붙일 때 사용하는 단어 (변수명, 함수명, 클래스명 ...)
// - 키워드(예약어) 사용 불가능
//    - 키워드란? 특별한 역할을 이미 하고 있는 단어
//    - ex. let, var, const, void, return, for, while, class, if, else ... 이런거 다 못씀
// - 숫자 시작 x
// - 특수문자: _, $ 만 허용
...
// 1. string (문자열)
// : 텍스트 정보, 따옴표로 감싸야 함
// : 숫자, 특수문자도 따옴표 안에 포함되면 문자열로 볼 수 있다.
let text = '안녕하세요!';
let text2 = '하이!';
let gender = '남자';
console.log(text);
console.log(text2);
console.log(gender);
console.log(text + text2 + gender);
// 템플릿 리터럴(es6) 백틱(`)와 달러, 중괄호(${}) 조합으로 사용
// : 문자열 내에서 변수와 상수를 간결히 표현
console.log(`${text} 저는 태훈입니다. 저의 성별은 ${gender}입니다!`);
...
// 사용방식 1. typeof(x) 2. typeof x
console.log(typeof '문자'); // string
console.log(typeof 12345); // number
console.log(typeof 3.14); // number
console.log(typeof true); // boolean
console.log(typeof false); // boolean
console.log(typeof null); // object ** js 에서 공식적으로 인정한 언어 자체의 오류
console.log(typeof undefined); // undefined
console.log(typeof fruits); // object ** Array도 object이다
...
console.log(Number(n3)); // n3 값을 실수(float)로 바꾸겠다 => 123.9
